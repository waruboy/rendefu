...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kolega.telepon'
        db.add_column('utama_kolega', 'telepon',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Kolega.email'
        db.add_column('utama_kolega', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kolega.telepon'
        db.delete_column('utama_kolega', 'telepon')

        # Deleting field 'Kolega.email'
        db.delete_column('utama_kolega', 'email')
