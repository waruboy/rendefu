...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kolega.organisasi'
        db.add_column('utama_kolega', 'organisasi',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['utama.Organisasi']),
                      keep_default=False)

        # Adding field 'PoinKontak.kolega'
        db.add_column('utama_poinkontak', 'kolega',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['utama.Kolega']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kolega.organisasi'
        db.delete_column('utama_kolega', 'organisasi_id')

        # Deleting field 'PoinKontak.kolega'
        db.delete_column('utama_poinkontak', 'kolega_id')
