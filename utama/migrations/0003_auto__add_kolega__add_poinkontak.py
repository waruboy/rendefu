...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('utama_kolega', (
            ...
            ('alamat', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ditambahkan', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('utama', ['Kolega'])

        # Adding model 'PoinKontak'
        db.create_table('utama_poinkontak', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('waktu', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('kontak', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('utama', ['PoinKontak'])


    def backwards(self, orm):
        # Deleting model 'Kolega'
        db.delete_table('utama_kolega')

        # Deleting model 'PoinKontak'
        db.delete_table('utama_poinkontak')
