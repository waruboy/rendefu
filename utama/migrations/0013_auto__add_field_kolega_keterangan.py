...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kolega.keterangan'
        db.add_column('utama_kolega', 'keterangan',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kolega.keterangan'
        db.delete_column('utama_kolega', 'keterangan')
    ...
    models = {
        ...
        'utama.aktivitas': {
            ...
            'dibuat': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tanggal_selesai': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
        'utama.kolega': {
            'Meta': {'object_name': 'Kolega'},
            'alamat': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'dihapus': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
