...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitas.tanggal_selesai'
        db.add_column('utama_aktivitas', 'tanggal_selesai',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitas.tanggal_selesai'
        db.delete_column('utama_aktivitas', 'tanggal_selesai')
