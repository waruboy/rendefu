...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Aktivitas'
        db.create_table('utama_aktivitas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('nama', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('selesai', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('utama', ['Aktivitas'])

        # Adding field 'PoinKontak.aktivitas'
        db.add_column('utama_poinkontak', 'aktivitas',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utama.Aktivitas'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Aktivitas'
        db.delete_table('utama_aktivitas')

        # Deleting field 'PoinKontak.aktivitas'
        db.delete_column('utama_poinkontak', 'aktivitas_id')
