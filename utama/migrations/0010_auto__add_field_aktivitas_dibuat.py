...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Aktivitas.dibuat'
        db.add_column('utama_aktivitas', 'dibuat',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 2, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Aktivitas.dibuat'
        db.delete_column('utama_aktivitas', 'dibuat')
