...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kolega.tanggal_lahir'
        db.add_column('utama_kolega', 'tanggal_lahir',
                      self.gf('django.db.models.fields.DateField')(null='True', blank='True'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kolega.tanggal_lahir'
        db.delete_column('utama_kolega', 'tanggal_lahir')
